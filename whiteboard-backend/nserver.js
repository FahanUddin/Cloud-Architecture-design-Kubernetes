...
const acquireLock = async (lockKey, lockValue) => {
    return await redisClient.set(lockKey, lockValue, 'NX', 'EX', 5);
};
...
setInterval(broadcastPeriodicUpdates, 5000); // Start the periodic broadcast when the server starts
